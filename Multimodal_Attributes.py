...
new_labels_data = np.array(labels_data)
...
print(f"F1 Per Attribute for Neurotypical:")
for l, f in zip(label_attribute_names, f1_per_label_neurotypical):
    print(f"{l}: {f:.5f}")
...
print(f"F1 Per Attribute for Neurodivergent:")
for l, f in zip(label_attribute_names, f1_per_label_neurodivergent):
    print(f"{l}: {f:.5f}")
