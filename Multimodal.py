...
if __name__ == "__main__":
    ...
    parser.add_argument("--emotions_task", action="store_true", help="True if running emotional classification task; False if running emotional dimensional classification task")
    parser.add_argument("--path_to_folder", action="store_true", help="Path to working directory")
